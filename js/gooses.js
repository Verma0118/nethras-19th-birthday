(function () {
  const GOOSE_SVG = (
    '<svg class="goose__art" viewBox="0 0 52 44" width="52" height="44" aria-hidden="true" focusable="false">' +
  ...
  const PATHS = {
    intro: [
      { id: 'a', dur: 22, delay: 0, keyframes: 'goosePathIntroA' },
      { id: 'b', dur: 26, delay: 4, keyframes: 'goosePathIntroB' },
    ],
    home: [
      { id: 'a', dur: 24, delay: 0, keyframes: 'goosePathHomeA' },
      { id: 'b', dur: 28, delay: 2, keyframes: 'goosePathHomeB' },
      { id: 'c', dur: 20, delay: 5, keyframes: 'goosePathHomeC' },
      { id: 'd', dur: 32, delay: 1, keyframes: 'goosePathHomeD' },
    ],
  };
  ...
  function buildTrail() {
    ...
    trail.innerHTML =
      ...
      '<path d="M2 20 Q12 4 38 10" fill="none" stroke="rgba(255,255,255,0.35)" stroke-width="2" stroke-dasharray="4 5" stroke-linecap="round"/>' +
      '</svg>';
    return trail;
  }
